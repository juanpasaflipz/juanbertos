...
const ADDRESS_NEIGHBORHOOD = "Roma Norte, 06700 CDMX";
...
/* Menu — placeholder copy + emoji icons until real photography lands. */
type MenuItem = {
  id: string;
...
const Home: NextPage = () => {
  ...
  return (
    <>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "JUANBERTO'S",
              description:
                "Burritos californianos en Roma Norte, CDMX. Carne asada. Papas adentro. Hecho con corazón.",
              ...
              image: "https://es.juanbertos.com/og-image.png",
              logo: "https://es.juanbertos.com/logo.png",
              sameAs: [IG_URL],
            }),
          }}
        />
      ...
      >
        {/* Decorative dotted half-rings echoing the logo */}
        ...
        >
          ...
          >
            <img
              src="/logo.png"
              alt="Juanberto's — Burritos Californianos · Hecho con corazón"
              className="mx-auto w-56 sm:w-72 md:w-80 drop-shadow-[0_4px_24px_rgba(45,90,45,0.18)]"
            />
          </motion.div>

          {/* Eyebrow — "world famoso since 2026" pulled from the logo */}
          <motion.p
          ...
          >
            {ADDRESS_LINE} · {ADDRESS_NEIGHBORHOOD}
          </motion.p>
        </motion.div>
      ...
      <main>
        ...
        <section
          id="menu"
          className="relative py-24 md:py-36 px-6 bg-cream"
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
              {MENU.map((item, i) => (
                <FadeIn key={item.id} delay={0.05 * i}>
                  ...
                  >
                    {/* Image placeholder — gradient + burrito mark. Replace with real photo via <img src={item.imageUrl} /> */}
                    <div
              ...
              <FadeIn delay={0.15}>
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 p-6 text-center">
                    ...
                    <p className="text-sm text-ink-soft">{ADDRESS_NEIGHBORHOOD}</p>
